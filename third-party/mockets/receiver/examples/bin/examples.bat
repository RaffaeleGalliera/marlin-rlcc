...
set CLASSPATH=%APP_HOME%\lib\examples.jar;%APP_HOME%\lib\picocli-4.3.2.jar;%APP_HOME%\lib\jmockets-1.2.jar;%APP_HOME%\lib\args4j-2.0.25.jar;%APP_HOME%\lib\logback-classic-1.2.3.jar;%APP_HOME%\lib\jutil-1.0.jar;%APP_HOME%\lib\measure.jar;%APP_HOME%\lib\jnats-1.0.jar;%APP_HOME%\lib\slf4j-api-1.7.36.jar;%APP_HOME%\lib\lombok-1.18.20.jar;%APP_HOME%\lib\grpc-1.0-SNAPSHOT.jar;%APP_HOME%\lib\grpc-netty-shaded-1.43.2.jar;%APP_HOME%\lib\reflections-0.9.11.jar;%APP_HOME%\lib\grpc-protobuf-1.47.0.jar;%APP_HOME%\lib\grpc-stub-1.47.0.jar;%APP_HOME%\lib\protobuf-java-util-3.12.2.jar;%APP_HOME%\lib\grpc-netty-1.47.0.jar;%APP_HOME%\lib\grpc-protobuf-lite-1.47.0.jar;%APP_HOME%\lib\grpc-core-1.47.0.jar;%APP_HOME%\lib\grpc-api-1.47.0.jar;%APP_HOME%\lib\guava-31.0.1-android.jar;%APP_HOME%\lib\bctls-jdk15on-1.70.jar;%APP_HOME%\lib\snakeyaml-1.8.jar;%APP_HOME%\lib\ipaddress-5.0.0.jar;%APP_HOME%\lib\bcpkix-jdk15on-1.66.jar;%APP_HOME%\lib\junit-4.12.jar;%APP_HOME%\lib\logback-core-1.2.3.jar;%APP_HOME%\lib\failureaccess-1.0.1.jar;%APP_HOME%\lib\listenablefuture-9999.0-empty-to-avoid-conflict-with-guava.jar;%APP_HOME%\lib\jsr305-3.0.2.jar;%APP_HOME%\lib\checker-qual-3.12.0.jar;%APP_HOME%\lib\error_prone_annotations-2.10.0.jar;%APP_HOME%\lib\j2objc-annotations-1.3.jar;%APP_HOME%\lib\animal-sniffer-annotations-1.19.jar;%APP_HOME%\lib\bcutil-jdk15on-1.70.jar;%APP_HOME%\lib\bcprov-jdk15on-1.70.jar;%APP_HOME%\lib\proto-google-common-protos-2.0.1.jar;%APP_HOME%\lib\protobuf-java-3.19.2.jar;%APP_HOME%\lib\Java-WebSocket-1.3.8.jar;%APP_HOME%\lib\commons-lang3-3.8.1.jar;%APP_HOME%\lib\cloning-1.9.3.jar;%APP_HOME%\lib\hamcrest-core-1.3.jar;%APP_HOME%\lib\perfmark-api-0.25.0.jar;%APP_HOME%\lib\checker-compat-qual-2.5.5.jar;%APP_HOME%\lib\grpc-context-1.47.0.jar;%APP_HOME%\lib\commons-math3-3.6.1.jar;%APP_HOME%\lib\gson-2.9.0.jar;%APP_HOME%\lib\javassist-3.21.0-GA.jar;%APP_HOME%\lib\objenesis-2.1.jar;%APP_HOME%\lib\annotations-4.1.1.4.jar;%APP_HOME%\lib\netty-codec-http2-4.1.72.Final.jar;%APP_HOME%\lib\netty-handler-proxy-4.1.72.Final.jar;%APP_HOME%\lib\netty-transport-native-unix-common-4.1.72.Final.jar;%APP_HOME%\lib\netty-codec-http-4.1.72.Final.jar;%APP_HOME%\lib\netty-handler-4.1.72.Final.jar;%APP_HOME%\lib\netty-codec-socks-4.1.72.Final.jar;%APP_HOME%\lib\netty-codec-4.1.72.Final.jar;%APP_HOME%\lib\netty-transport-4.1.72.Final.jar;%APP_HOME%\lib\netty-buffer-4.1.72.Final.jar;%APP_HOME%\lib\netty-resolver-4.1.72.Final.jar;%APP_HOME%\lib\netty-common-4.1.72.Final.jar;%APP_HOME%\lib\netty-tcnative-classes-2.0.46.Final.jar
